...
// Generated by CoffeeScript 1.10.0
(function() {
  var FM, cookies, error, error1, fetch, fetchMailboxes, fetchMessages, relogin;
  ...
  fetchMessages = function(mailbox, page, callback) {
    return FM.postJSON('/api/message/list', {
      lmrCredentials: {
        cHost: FM.host,
        cEmail: FM.email,
  ...
  fetch = function() {
    var action, item, mailbox, query;
    query = window.location.hash.substring(1).split('/');
    action = query[0] || 'list';
    mailbox = query[1] || 'INBOX';
    item = query[2] || 1;
